<div class="panel" >
	<div class="">
		<a href="#" class="btn btn-primary" id="add_dest_filter">添加</a>
	</div>
	
	<table class='table' id="dest_list_table">
		<tr>
			<th>ID</th>
			<th>图片</th>
			<th>名字</th>
...
<div class="modal fade" id="myDestEditor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
