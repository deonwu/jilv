     ...
     <div class = "col-lg-10 col-md-10 ">
              ...
              <div class="panel panel-default">
                      <div class="panel-heading">
                          <h4>【<strong>驳回处理</strong>】 <strong style='color:red'>&nbsp;&nbsp;<?=$shop['shop_name']?></strong></h4>
                      </div>
                      <div class="panel-body">
                                      
                                   <div class="form" role="form" id="refund_info">
                                   
                                        <input type="hidden" name="shop_id" value="<?=$shop['shop_id']?>">
                                        
                                        <?php $refund = json_decode($shop['refund_content'],true)?>
