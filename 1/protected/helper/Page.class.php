...
class Page {
	...
	*/
	...
	var $first_link   		= '&lsaquo;&lsaquo; 首页';  //第一页的文字
	var $next_link			= '&gt;';	//下一页的文字
	var $prev_link			= '&lt;'; 	//上一页的文字
	var $last_link			= '尾页 &rsaquo;&rsaquo;'; //最后一页的文字
	...
	function create_links(){
		...
		if(DEBUG){
			echo "num_pages:$num_pages,total_rows:{$this->total_rows},per_page:{$this->per_page}";
	...
	//$output .="{$this->num_tag_open}$num_pages{$this->num_tag_close}";
