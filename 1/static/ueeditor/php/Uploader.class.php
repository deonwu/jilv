...
class Uploader
{
    ...
    private function getFolder()
    {
        ...
        $this->test_path="child path:".$childpath.",pathstr:".$pathStr;

        if ( !file_exists( $pathStr) ) {

            if (!$this->create_folder($childpath,$pathStr)){
                return false;
            }
        }
        return $pathStr;
    ...
    private function create_folder($childpath,$pathStr){
         mkdir( $pathStr , 0777 , true );
